  ...
  const handleDelete = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/api/datosusuario/${producto.id}`,
        {
          method: "DELETE",
        }
      );
      if (response.ok) {
        ...
        closeModal()
        obtenerProductosDummy()
        //Aqui debe de ir la actualizacion
      } else {
           ...
           <div className="mb-4">
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, puesto: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, correo: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, nombre_dependencia: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, domicilio: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, telefono: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, nombre_titular: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, cargo_puesto: e.target.value })}
              />
            </div>
            ...
            <div className="mb-4">
             ...
             <input
               ...
               onChange={(e) => setEditedProduct({ ...editedProduct, departamento_area: e.target.value })}
              />
            </div>
            <button
